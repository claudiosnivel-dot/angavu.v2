...
| Ultimo commit | `c5a2d04` E-4 `ScanCarouselContent` — **`[skip ci]`, NON verificato** (CI bloccata, minuti macOS esauriti). **Ultimo CODICE VERIFICATO (CI verde)**: `3fa47de` P0-2 (run #61) e `5d22222` P0-3/P0-4 (run #60). **Costruiti ma NON verificati** (da validare al ripristino runner): `71c9814` P0-1 (run #62 no-runner), `25e7fc2` A-1, `d4ead0c` A-2/A-3, `099aeea` B-1, `c5a2d04` E-4. Storico verificato: `8a383b0` letture off-main (run #59), `03c49b1` scan O(N) (run #58/#57). |
