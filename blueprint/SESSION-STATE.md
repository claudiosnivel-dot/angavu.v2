...
| Ultimo commit | `03c49b1` bugfix runtime scansione — **CI Apple `success`** (run id 32829651215). Sequenza di sessione: `528c538` (mappatura O(N²)→O(N)), `e3011ae` (indice SwiftData su contesto dedicato), `db71030`→`db3fefa` (upsert batch), `0f04ecc` (docs: correzione stato app). Storico blueprint: `d4d1cac` feat(ui-shell) R-11 (CI verde run #49), `0d9ed69` (R-10, #48), `4aef03c` (R-09, #47) |
...
- **BUGFIX on-device — freeze della scansione** (questa sessione). Al primo test
